...
Object.defineProperty(exports, "CanvasLayer", {
  enumerable: true,
  get: function get() {
    return _reactBaiduMapCanvasLayer.default;
  }
});
...
var _reactBaiduMapCanvasLayer = _interopRequireWildcard(require("@uiw/react-baidu-map-canvas-layer"));

Object.keys(_reactBaiduMapCanvasLayer).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _reactBaiduMapCanvasLayer[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function get() {
      return _reactBaiduMapCanvasLayer[key];
    }
  });
});
