...
function usePolyline() {
  ...
  var _useState3 = (0, _react.useState)(props.path || []),
      ...
      path = _useState4[0],
      setPath = _useState4[1]; // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  (0, _reactBaiduMapUtils.useEnableProperties)(polyline, props, ['Editing', 'MassClear']); // PositionAt
