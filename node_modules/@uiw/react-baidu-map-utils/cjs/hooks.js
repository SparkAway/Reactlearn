...
function useProperties(instance, props) {
  var propsName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
  propsName.forEach(function (name) {
    var eName = "".concat(name.charAt(0).toLowerCase()).concat(name.slice(1)); // eslint-disable-next-line react-hooks/rules-of-hooks

    var _useState3 = (0, _react.useState)(props[eName]),
        _useState4 = (0, _slicedToArray2.default)(_useState3, 2),
        state = _useState4[0],
        setState = _useState4[1]; // eslint-disable-next-line react-hooks/rules-of-hooks
