...
function useCurveLine() {
  ...
  var _useState5 = (0, _react.useState)(false || !!libSDK),
      ...
      setLoadBMapLib = _useState6[1]; // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  (0, _reactBaiduMapUtils.useEnableProperties)(curveLine, props, ['Editing', 'MassClear']); // PositionAt
