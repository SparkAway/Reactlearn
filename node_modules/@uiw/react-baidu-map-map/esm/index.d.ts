...
export declare type MapChildRenderProps = {
    children?: (data: {
        BMap: typeof BMap;
        map: BMap.Map;
...
export declare function Provider(props: MapChildRenderProps): JSX.Element;
declare const _default: React.ForwardRefExoticComponent<(MapProps & MapChildRenderProps) & React.RefAttributes<MapProps & {
